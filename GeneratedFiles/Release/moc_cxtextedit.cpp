...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_CxTextEdit_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 28, 0)
    ...
    "CxTextEdit\0__showTextFormat\0\0"
};
...
void CxTextEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->__showTextFormat(); break;
        default: ;
        }
        ...
        {
            typedef void (CxTextEdit::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CxTextEdit::__showTextFormat)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject CxTextEdit::staticMetaObject = {
    { &QTextEdit::staticMetaObject, qt_meta_stringdata_CxTextEdit.data,
      qt_meta_data_CxTextEdit,  qt_static_metacall, 0, 0}
};
...
// SIGNAL 0
void CxTextEdit::__showTextFormat()
{
